...
class WpPerformance_Admin {
	...
	public function menu() {
		add_submenu_page( 'optimisationio-statistics-and-addons', __( 'WP Disable', 'wpperformance' ), __( 'WP Disable', 'wpperformance' ), 'manage_options', 'optimisationio-wp-disable', array( $this, 'addsettings' ) );
