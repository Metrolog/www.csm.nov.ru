...
function WP_PRELOAD_PJAX(){
	wp_enqueue_script( 'preload', plugins_url().'/wp-preload-pjax/jquery.preload.js', array('jquery'), false, true );
	wp_enqueue_script( 'pjax', plugins_url().'/wp-preload-pjax/jquery.pjax.js', array('jquery'), false, true );
